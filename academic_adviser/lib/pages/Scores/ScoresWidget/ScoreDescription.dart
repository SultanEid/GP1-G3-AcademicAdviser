...
class ScoreDescription extends StatelessWidget {
  const ScoreDescription({Key? key, required this.score, required this.color, required this.stdList, required this.current})
      : super(key: key);
  final Score score;
  final Color color;
                            ...
                            RadialAxis(
                                ...
                                annotations: [
                                  GaugeAnnotation(
                                    positionFactor: 0.2,
                                    angle: 90,
                                    widget: Text(score.percent.toStringAsFixed(0).toString(),
                                      style: TextStyle(
                                          fontFamily: 'Tajawal',
                                          color: color,
                                          fontWeight: FontWeight.bold,
                    ...
                    child: Row(
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            stdList[index].myScores[current].toStringAsFixed(0) + '%',
                            textAlign: TextAlign.left,
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 25.sp,
