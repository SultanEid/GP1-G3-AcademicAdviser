...
class ScoresR extends StatelessWidget {
  ScoresR({Key? key , required this.student}) : super(key: key);
  Student student;
  // List<Score> list = [
  //   Score(
  ...
  //     scoreTag: 'English',
  //     scoreDescription:
  //         'English indicator score is measuring English skills and scores',
  //     plo: [
  //       CourseDegreePLO(
  //         courseName: 'ENG 101',
  //         courseDgree: 90,
