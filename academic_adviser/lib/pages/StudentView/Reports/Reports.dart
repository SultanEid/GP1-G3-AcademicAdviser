...
import 'package:academic_adviser/pages/StudentView/Reports/ReportWidget/ProfileWidget.dart';
...
class StudentReport extends StatefulWidget {
  StudentReport({Key? key, required this.user}) : super(key: key);
  Student user;

  @override
  State<StudentReport> createState() => _ReportState(user: user);
}

class _ReportState extends State<StudentReport> {
  ...
  Future<void> _convertImageToPDF() async {
    ...
    for (int index = 0; index < indexes.length; index++) {
      ...
      page.graphics
          .drawImage(image, Rect.fromLTWH(0, top, size.width, size.height));
      top += size.height;
    }
