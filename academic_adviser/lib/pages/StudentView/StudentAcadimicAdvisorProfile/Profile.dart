...
import '../../AcademicAdvisorView/Profile/ProfileWidget/BrifeWidget.dart';
import '../../AcademicAdvisorView/Profile/ProfileWidget/CertificatesWidget.dart';
import '../../AcademicAdvisorView/Profile/ProfileWidget/ProfileWidget.dart';
import '../../UniversalWidgetAA/AAA_Icons_Pack.dart';
import '../../Wrapper.dart';
import '../Dashboard/Dashboard.dart';

class StudentAcadimicAdvisorProfile extends StatefulWidget {
  StudentAcadimicAdvisorProfile({Key? key,  required this.student}) : super(key: key);
  Student student;

  @override
  State<StudentAcadimicAdvisorProfile> createState() => _StudentAcadimicAdvisorProfile(student: student);
}
class _StudentAcadimicAdvisorProfile extends State<StudentAcadimicAdvisorProfile> {
  _StudentAcadimicAdvisorProfile({Key? key,  required this.student});
  Student student;
  late AcademicAdvisor user;
  late ThemeConfig themeConfig;
  @override
  Widget build(BuildContext context) {
    user = student.academicAdvisor!;
                      ...
                      children: [
                        Container(
                          ...
                          child: RawMaterialButton(
                            ...
                            onPressed: () {
                              Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) => StudentServices(student: student,)!), (Route<dynamic> route) => false);
                            },
                            child: ShaderMask(
                              child: SizedBox(
                                width: 36.w * 1.2,
